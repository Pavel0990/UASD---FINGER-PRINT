...
const I18N = {
  es: {
    ...
    rep_active_now: 'Presentes por departamento',
    rep_active_now_sub: 'Empleados en el recinto',
    rep_donut_active: 'Activos',
  ...
  en: {
    ...
    rep_active_now: 'Present by department',
    rep_active_now_sub: 'Employees on the premises',
    rep_donut_active: 'Active',
...
const DEFAULT_DEPARTMENTS = [
  ...
  'Facultad de Humanidades', 'Facultad de Ciencias', 'Seguridad', 'Registro',
  'Comunicaciones', 'Economato', 'Caja',
];
